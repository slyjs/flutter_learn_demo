class DetailsModel {
  String code;
  String message;
  DetailsGoodsData detailsGoodsData;

  DetailsModel({this.code, this.message, this.detailsGoodsData});

  DetailsModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    detailsGoodsData = json['data'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.detailsGoodsData != null) {
      data['data'] = this.detailsGoodsData.toJson();
    }
    return data;
  }
}
